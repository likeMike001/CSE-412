        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div className="absolute bottom-2 left-2 text-white flex flex-wrap gap-1">
                        {movie.genres?.slice(0, 2).map((genre, idx) => (
                            <span
                                key={idx}
                                className="px-2 py-1 bg-gray-700 rounded-full text-xs text-gray-200"
                ...
                >
                    <div
                        className="p-3 text-white w-full h-full overflow-y-auto text-center text-xs scrollbar-custom"
                    >
                        <h3 className="text-sm font-bold mb-2">{movie.title}</h3>
                        <p className="text-xs text-gray-300">Year: {movie.year}</p>
